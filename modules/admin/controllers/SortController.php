...
class SortController extends Controller
{
    ...
    public function beforeAction($action)
    {
        ...
        if (!isset(Yii::$app->params['modelSortPermission'][$modelClass])) {
            throw new BadRequestHttpException('Model class is not allowed for sortable.');
        }

        if (!Yii::$app->user->can(Yii::$app->params['modelSortPermission'][$modelClass])) {
            throw new ForbiddenHttpException('You can not edit the sort order for this model.');
        }
